            ...
            if (cmd.indices || cmd.vertexArray?.indices) {
                ...
                if (instanced) {
                    if (cmd.multiDraw && ctx.capabilities.multiDraw) {
                        if (cmd.multiDraw.baseVertices && cmd.multiDraw.baseInstances && ctx.capabilities.multiDrawInstancedBase) {
                        ...
                        if (Number.isFinite(cmd.baseVertex) && Number.isFinite(cmd.baseInstance) && ctx.capabilities.drawInstancedBase) {
                            const ext = gl.getExtension("WEBGL_draw_instanced_base_vertex_base_instance");
                            ext.drawElementsInstancedBaseVertexBaseInstanceWEBGL(primitive, count, type, offset, cmd.instances, cmd.baseVertex, cmd.baseInstance);
                        } else {
                ...
                if (instanced) {
                    if (cmd.multiDraw && ctx.capabilities.multiDraw) {
                        ...
                        if (Number.isFinite(cmd.baseInstance) && ctx.capabilities.drawInstancedBase) {
                            const ext = gl.getExtension("WEBGL_draw_instanced_base_vertex_base_instance");
                            ext.drawArraysInstancedBaseInstanceWEBGL(primitive, first, cmd.count, cmd.instances, cmd.baseInstance);
                        } else {
